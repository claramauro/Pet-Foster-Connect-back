...
async function sendAccommodationRequestForAnimal(email) {
    try {
        ...
        const mailOptions = {
            ...
            subject: "Une demande d'hébergement vient d'etre faite",  // Sujet de l'email
            html: `<!DOCTYPE html>
...
export { sendAccommodationRequestForAnimal };